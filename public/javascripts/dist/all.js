...
module.exports = React.createClass({
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement("input", { ref: "name", type: "text", placeholder: "Name" }),
					...
					React.createElement("br", null),
					React.createElement("input", { ref: "email", type: "text", placeholder: "Email" }),
					React.createElement("p", null),
					React.createElement(
						"label",
						null,
					...
					React.createElement("br", null),
					React.createElement("input", { ref: "subject", type: "text", placeholder: "Subject" }),
					React.createElement("p", null),
					React.createElement(
						"label",
						null,
	...
	submitForm: function submitForm(e) {
		...
		$.get("http://localhost:3000/send-email", submission);

		this.props.myRouter.navigate("success", { trigger: true });
	}
});

},{"jquery":4,"react":159}],161:[function(require,module,exports){
"use strict";
...
module.exports = React.createClass({
	...
	returnToForm: function returnToForm(e) {
		e.preventDefault();
...
var App = Backbone.Router.extend({
	...
	contact: function contact() {
		React.render(React.createElement(ContactComponent, { myRouter: myRouter }), document.getElementById('container'));
	},
	success: function success() {
		React.render(React.createElement(SuccessComponent, { myRouter: myRouter }), document.getElementById('container'));
	}
...
},{"./components/ContactComponent.js":160,"./components/SuccessComponent.js":161,"backbone":1,"react":159}]},{},[162])
